...
if __name__ == "__main__":
    ...
    scen_opts = {locations[0]: {'New restrictions enforced mid-July small effect, eased mid-August':
                                    {'replace': (['relockdown_v1'], [['relax']], [[mid_aug]])},
                                ...
                                'New restrictions enforced mid-July small effect, eased mid-September':
                                    {'replace': (['relockdown_v1'], [['relax']], [[mid_sep]])},
                                ...
                                'New restrictions moderate effect, never released':
                                    {'replace': (['relockdown_v1'], [['relax']], [[500]])},
                                    }}
    ...
    small = 1
    mod = 0.9
    scens['scenarios'][locations[0]].scenarios['New restrictions enforced mid-July small effect, eased mid-August']['pars']['interventions'][0].policies['relockdown_v1'] = \
        {'H': small, 'S': small, 'W': small, 'C': small}
    scens['scenarios'][locations[0]].scenarios['New restrictions enforced mid-July small effect, eased mid-September']['pars']['interventions'][0].policies['relockdown_v1'] = \
        {'H': small, 'S': small, 'W': small, 'C': small}
    scens['scenarios'][locations[0]].scenarios['New restrictions enforced mid-July moderate effect, eased mid-August']['pars']['interventions'][0].policies['relockdown_v1'] = \
        {'H': mod, 'S': mod, 'W': mod, 'C': mod}
    scens['scenarios'][locations[0]].scenarios['New restrictions enforced mid-July moderate effect, eased mid-September']['pars']['interventions'][0].policies['relockdown_v1'] = \
        {'H': mod, 'S': mod, 'W': mod, 'C': mod}
    scens['scenarios'][locations[0]].scenarios['New restrictions moderate effect, never released']['pars']['interventions'][0].policies['relockdown_v1'] = \
        {'H': mod, 'S': mod, 'W': mod, 'C': mod}
    ...
    cum_inf_MB_sep_oct = \
        scens['scenarios'][locations[0]].results['cum_infections'][
            'New restrictions enforced mid-July moderate effect, eased mid-August']['best'][end_oct]
    ...
    cum_inf_MB_nov_dec = \
        scens['scenarios'][locations[0]].results['cum_infections'][
            'New restrictions enforced mid-July moderate effect, eased mid-August']['best'][end_dec]
    ...
    cum_inf_UB_sep_oct = \
        scens['scenarios'][locations[0]].results['cum_infections'][
            'New restrictions enforced mid-July small effect, eased mid-August']['best'][end_oct]
    ...
    cum_inf_UB_nov_dec = \
        scens['scenarios'][locations[0]].results['cum_infections'][
            'New restrictions enforced mid-July small effect, eased mid-August']['best'][end_dec]
