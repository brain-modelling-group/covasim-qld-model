...
if __name__ == "__main__":
    ...
    user_pars = {locations[0]: {'pop_size': int(10e4),
                        ...
                        'n_days': 330,
                        'pop_infected': 100,
                        'calibration_end': '2020-08-12'}}

    mid_july = 139 # make this the key date
    mid_aug = mid_july + 31
    mid_sep = mid_aug + 31
    end_oct = mid_sep + 46
    mid_nov = end_oct + 15
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                       fig_path=dirname + '/figs_tilburg/Tilburg-projection' + '.png',
    ...
    new_inf_MB_sep_oct = sum(
        scens['scenarios'][locations[0]].results['new_infections'][
            'Small easing of restrictions in mid-September']['best'][
        mid_sep:end_oct])
    ...
    cum_inf_MB_sep_oct = \
        scens['scenarios'][locations[0]].results['cum_infections'][
            'Small easing of restrictions in mid-September']['best'][end_oct]
    ...
    cum_inf_MB_nov_dec = \
        scens['scenarios'][locations[0]].results['cum_infections'][
            'Small easing of restrictions in mid-September']['best'][end_dec]
