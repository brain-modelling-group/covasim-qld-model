...
pl.plot(tvec, diagvals[2], c=colors[2], label="No mask scenario", lw=4, alpha=1.0)
pl.plot(tvec, diagvals[1], c=colors[1], label="Moderate mask scenario", lw=4, alpha=1.0)
...
pl.plot(tvec, infvals[1], c=colors[1], label="Moderate mask scenario", lw=4, alpha=1.0)
pl.plot(tvec, infvals[2], c=colors[2], label="No mask scenario", lw=4, alpha=1.0)
