...
if __name__ == "__main__":
    ...
    scen_opts = {'Barretos': {'No changes to current lockdown restrictions':
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                       fig_path=dirname + '/figs/Barretos-calibrate' + '.png',
    ...
    '''
    cum_diag_calib_end1 = \
    scens['scenarios']['Barretos'].results['cum_diagnoses']['No changes to current lockdown restrictions']['best'][54]
    cum_diag_calib_1week = \
    scens['scenarios']['Barretos'].results['cum_diagnoses']['No changes to current lockdown restrictions']['best'][61]
    cum_diag_calib_2week = \
    scens['scenarios']['Barretos'].results['cum_diagnoses']['No changes to current lockdown restrictions']['best'][68]
    cum_diag_calib_end2 = \
    scens['scenarios']['Barretos'].results['cum_diagnoses']['No changes to current lockdown restrictions']['best'][101]
    cum_death_calib_end1 = \
    scens['scenarios']['Barretos'].results['cum_deaths']['No changes to current lockdown restrictions']['best'][54]
    cum_death_calib_1week = \
    scens['scenarios']['Barretos'].results['cum_deaths']['No changes to current lockdown restrictions']['best'][61]
    cum_death_calib_2week = \
    scens['scenarios']['Barretos'].results['cum_deaths']['No changes to current lockdown restrictions']['best'][68]
    cum_death_calib_end2 = \
    scens['scenarios']['Barretos'].results['cum_deaths']['No changes to current lockdown restrictions']['best'][101]

    workbook = xlsxwriter.Workbook('Barretos_validation.xlsx')
