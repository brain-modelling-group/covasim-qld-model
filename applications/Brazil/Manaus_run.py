...
if __name__ == "__main__":
    ...
    # scen_opts = {'Manaus': {'No changes to current lockdown restrictions': 
    scen_opts = {'Manaus': {'Small easing of restrictions on September 15': 
    ...
    new_no_release = sum(scens['scenarios']['Manaus'].results['new_infections']['No changes to current lockdown restrictions']['best'][249:368])    
    new_september_smallrelease = sum(scens['scenarios']['Manaus'].results['new_infections']['Small easing of restrictions on September 15']['best'][249:368])    
    new_september_moderaterelease = sum(scens['scenarios']['Manaus'].results['new_infections']['Moderate easing of restrictions on September 15']['best'][249:368])    
    new_august_smallrelease = sum(scens['scenarios']['Manaus'].results['new_infections']['Small easing of restrictions on August 15']['best'][249:368])
    new_august_moderaterelease = sum(scens['scenarios']['Manaus'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][249:368])
    cum_no_release = scens['scenarios']['Manaus'].results['cum_infections']['No changes to current lockdown restrictions']['best'][368]
    cum_september_smallrelease = scens['scenarios']['Manaus'].results['cum_infections']['Small easing of restrictions on September 15']['best'][368]
    cum_september_moderatelrelease = scens['scenarios']['Manaus'].results['cum_infections']['Moderate easing of restrictions on September 15']['best'][368]
    cum_august_smallrelease = scens['scenarios']['Manaus'].results['cum_infections']['Small easing of restrictions on August 15']['best'][368]
    cum_august_moderatelrelease = scens['scenarios']['Manaus'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][368]
    cum_may18 = scens['scenarios']['Manaus'].results['cum_infections']['No changes to current lockdown restrictions']['best'][81]  
    
    with open('Manaus_projections.txt', 'w') as f:
