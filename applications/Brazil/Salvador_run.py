...
if __name__ == "__main__":
    ...
    new_no_release = sum(scens['scenarios']['Salvador'].results['new_infections']['No changes to current lockdown restrictions']['best'][249:368])    
    new_september_smallrelease = sum(scens['scenarios']['Salvador'].results['new_infections']['Small easing of restrictions on September 15']['best'][249:368])    
    new_september_moderaterelease = sum(scens['scenarios']['Salvador'].results['new_infections']['Moderate easing of restrictions on September 15']['best'][249:368])    
    new_august_smallrelease = sum(scens['scenarios']['Salvador'].results['new_infections']['Small easing of restrictions on August 15']['best'][249:368])
    new_august_moderaterelease = sum(scens['scenarios']['Salvador'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][249:368])
    cum_no_release = scens['scenarios']['Salvador'].results['cum_infections']['No changes to current lockdown restrictions']['best'][368]
    cum_september_smallrelease = scens['scenarios']['Salvador'].results['cum_infections']['Small easing of restrictions on September 15']['best'][368]
    cum_september_moderatelrelease = scens['scenarios']['Salvador'].results['cum_infections']['Moderate easing of restrictions on September 15']['best'][368]
    cum_august_smallrelease = scens['scenarios']['Salvador'].results['cum_infections']['Small easing of restrictions on August 15']['best'][368]
    cum_august_moderatelrelease = scens['scenarios']['Salvador'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][368]
    cum_may18 = scens['scenarios']['Salvador'].results['cum_infections']['No changes to current lockdown restrictions']['best'][81]  
    
    with open('Salvador_projections.txt', 'w') as f:
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                        fig_path=dirname + '/figs/Salvador-projections' + '.png',
