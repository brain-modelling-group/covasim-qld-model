...
if __name__ == "__main__":
    ...
    # country-Natalecific parameters
    user_pars = {'Natal': {'pop_size': int(10e4),
                               'beta': 0.0462,
                               'n_days': 289,
    ...
    # scen_opts = {'Natal': {'No changes to current lockdown restrictions': 
    scen_opts = {'Natal': {'Small easing of restrictions in mid-July': 
                              {'replace': (['relax1'], [['relax2']], [[181]]),
                              'policies': {'relax2': {'beta': 0.7}}},
                 
                            'Moderate easing of restrictions in mid-July': 
                              {'replace': (['relax1'], [['relax3']], [[181]]),
                              'policies': {'relax3': {'beta': 0.8}}},
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                        fig_path=dirname + '/figs/Natal-projection' + '.png',
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['Natal'].results['new_infections']['No changes to current lockdown restrictions']['best'][181:226])    
    new_diag_LB_sep_oct = sum(scens['scenarios']['Natal'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][181:226])    
    cum_inf_LB_sep_oct = scens['scenarios']['Natal'].results['cum_infections']['No changes to current lockdown restrictions']['best'][226]    
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['Natal'].results['new_infections']['No changes to current lockdown restrictions']['best'][228:271])    
    new_diag_LB_nov_dec = sum(scens['scenarios']['Natal'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][228:271])    
    cum_inf_LB_nov_dec = scens['scenarios']['Natal'].results['cum_infections']['No changes to current lockdown restrictions']['best'][271]    
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['Natal'].results['new_infections']['Small easing of restrictions in mid-August']['best'][181:226])    
    new_diag_MB_sep_oct = sum(scens['scenarios']['Natal'].results['new_diagnoses']['Small easing of restrictions in mid-August']['best'][181:226])    
    cum_inf_MB_sep_oct = scens['scenarios']['Natal'].results['cum_infections']['Small easing of restrictions in mid-August']['best'][226]    
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['Natal'].results['new_infections']['Small easing of restrictions in mid-August']['best'][228:271])    
    new_diag_MB_nov_dec = sum(scens['scenarios']['Natal'].results['new_diagnoses']['Small easing of restrictions in mid-August']['best'][228:271])    
    cum_inf_MB_nov_dec = scens['scenarios']['Natal'].results['cum_infections']['Small easing of restrictions in mid-August']['best'][271]    
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['Natal'].results['new_infections']['Moderate easing of restrictions in mid-July']['best'][181:226])    
    new_diag_UB_sep_oct = sum(scens['scenarios']['Natal'].results['new_diagnoses']['Moderate easing of restrictions in mid-July']['best'][181:226])    
    cum_inf_UB_sep_oct = scens['scenarios']['Natal'].results['cum_infections']['Moderate easing of restrictions in mid-July']['best'][226]    
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['Natal'].results['new_infections']['Moderate easing of restrictions in mid-July']['best'][228:271])    
    new_diag_UB_nov_dec = sum(scens['scenarios']['Natal'].results['new_diagnoses']['Moderate easing of restrictions in mid-July']['best'][228:271])    
    cum_inf_UB_nov_dec = scens['scenarios']['Natal'].results['cum_infections']['Moderate easing of restrictions in mid-July']['best'][271]    
