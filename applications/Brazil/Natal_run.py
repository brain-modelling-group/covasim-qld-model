...
if __name__ == "__main__":
    ...
    scen_opts = {'Natal': {'Small easing of restrictions in mid-September': 
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['Natal'].results['new_infections']['Moderate easing of restrictions in mid-September']['best'][181:226])    
    new_diag_UB_sep_oct = sum(scens['scenarios']['Natal'].results['new_diagnoses']['Moderate easing of restrictions in mid-September']['best'][181:226])    
    cum_inf_UB_sep_oct = scens['scenarios']['Natal'].results['cum_infections']['Moderate easing of restrictions in mid-September']['best'][226]    
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['Natal'].results['new_infections']['Moderate easing of restrictions in mid-September']['best'][228:271])    
    new_diag_UB_nov_dec = sum(scens['scenarios']['Natal'].results['new_diagnoses']['Moderate easing of restrictions in mid-September']['best'][228:271])    
    cum_inf_UB_nov_dec = scens['scenarios']['Natal'].results['cum_infections']['Moderate easing of restrictions in mid-September']['best'][271]    
