...
if __name__ == "__main__":
    ...
    locations = ['Barcelona10e4', 'Barcelona5e4']
    ...
    user_pars = {'Barcelona10e4': {'pop_size': int(10e4),
                               'beta': 0.14,
                               'n_days': 165,
                               'calibration_end': '2020-08-01'},
                 'Barcelona5e4': {'pop_size': int(5e4),
                               'beta': 0.14,
                               'n_days': 165,
                               'calibration_end': '2020-08-01'}}
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
              fig_path=dirname + '/figs' + locations[0] + '.png',
