...
if __name__ == "__main__":
    ...
    policy_change = {'Loreto': {'calibration':{'replace': (['heavy_lockdown'], [['phase_3']], [[150]])}}}
    ...
    scens['verbose'] = True
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True, fig_path=dirname + '/Loreto_calibration_v3' + '.png',
                       interval=30,
