...
if __name__ == "__main__":
    ...
    policy_change = {
        'Loreto': {'Restrictions relaxed in August': {'replace': (['heavy_lockdown'], [['phase_3']], [[150]])},
    ...
    August_release = sum(scens['Loreto'].results['new_infections']['Restrictions relaxed in August']['best'][243:363])
    print('5% of restrictions lifted in August =',August_release)
    November_release = sum(scens['Loreto'].results['new_infections']['Restrictions relaxed in November']['best'][243:363])
    print('5% of restrictions lifted in November  =', November_release)

    # PLOT
    dirname = os.path.dirname(__file__)
    scens['verbose'] = True
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True, fig_path=dirname + '/Loreto' + '.png',
                       interval=30,
