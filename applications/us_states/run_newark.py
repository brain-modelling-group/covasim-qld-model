...
if __name__ == "__main__":
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['Newark'].results['new_infections']['No changes to current lockdown restrictions']['best'][194:240])
    new_diag_LB_sep_oct = sum(scens['scenarios']['Newark'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][194:240])
    cum_inf_LB_sep_oct = scens['scenarios']['Newark'].results['cum_infections']['No changes to current lockdown restrictions']['best'][240]
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['Newark'].results['new_infections']['No changes to current lockdown restrictions']['best'][241:285])
    new_diag_LB_nov_dec = sum(scens['scenarios']['Newark'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][241:285])
    cum_inf_LB_nov_dec = scens['scenarios']['Newark'].results['cum_infections']['No changes to current lockdown restrictions']['best'][285]
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['Newark'].results['new_infections']['Small easing of restrictions on July 15']['best'][194:240])
    new_diag_MB_sep_oct = sum(scens['scenarios']['Newark'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][194:240])
    cum_inf_MB_sep_oct = scens['scenarios']['Newark'].results['cum_infections']['Small easing of restrictions on July 15']['best'][240]
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['Newark'].results['new_infections']['Small easing of restrictions on July 15']['best'][241:285])
    new_diag_MB_nov_dec = sum(scens['scenarios']['Newark'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][241:285])
    cum_inf_MB_nov_dec = scens['scenarios']['Newark'].results['cum_infections']['Small easing of restrictions on July 15']['best'][285]
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['Newark'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][194:240])
    new_diag_UB_sep_oct = sum(scens['scenarios']['Newark'].results['new_diagnoses']['Moderate easing of restrictions on August 15']['best'][194:240])
    cum_inf_UB_sep_oct = scens['scenarios']['Newark'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][240]
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['Newark'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][241:285])
    new_diag_UB_nov_dec = sum(scens['scenarios']['Newark'].results['new_diagnoses']['Moderate easing of restrictions on August 15']['best'][241:285])
    cum_inf_UB_nov_dec = scens['scenarios']['Newark'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][285]
