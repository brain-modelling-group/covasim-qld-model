...
if __name__ == "__main__":
    ...
    user_pars = {'Minesota': {'pop_size': int(5e4),
                               'beta': 0.05,
                               'n_days': 365,
                          'pop_infected': 300}
    ...
    policy_vals = {'Minesota': {'lockdown_1':{'beta': 1},
                                'lockdown_2': {'beta': 0.58},
                                'relax_1': {'beta': 0.6},
                                'relax_2': {'beta': 0.6},
                   }}
    # the policies to change during scenario runs

    policy_change = {'Minesota': {'Lockdown relax in August':{'replace': (['relax_1'], [['relax_2']], [[161]])}
                                                            }}
    ...
    scens['verbose'] = True
    utils.policy_plot2(scens, plot_ints=False, do_save=False, do_show=True,
                       fig_path=dirname + '/Minesota_in_prog_deaths' + '.png',
                       interval=30,
                       fig_args=dict(figsize=(10, 5), dpi=100),
                       font_size=11,
                       # y_lim={'new_infections': 500},
