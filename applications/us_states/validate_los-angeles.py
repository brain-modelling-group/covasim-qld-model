...
# Results
    cum_diag_calib_end1 = scens['scenarios']['Los Angeles'].results['cum_diagnoses']['No changes to current lockdown restrictions']['best'][69]
    cum_diag_calib_1week = scens['scenarios']['Los Angeles'].results['cum_diagnoses']['No changes to current lockdown restrictions']['best'][76]
    cum_diag_calib_2week = scens['scenarios']['Los Angeles'].results['cum_diagnoses']['No changes to current lockdown restrictions']['best'][83]
    cum_diag_calib_end2 = scens['scenarios']['Los Angeles'].results['cum_diagnoses']['No changes to current lockdown restrictions']['best'][116]
    cum_death_calib_end1 = scens['scenarios']['Los Angeles'].results['cum_deaths']['No changes to current lockdown restrictions']['best'][69]
    cum_death_calib_1week = scens['scenarios']['Los Angeles'].results['cum_deaths']['No changes to current lockdown restrictions']['best'][76]
