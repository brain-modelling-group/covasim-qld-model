...
if __name__ == "__main__":
    ...
    user_pars = {'Oakland': {'pop_size': int(10e4),
                               'beta': 0.037,
                               'n_days': 306,
                                'pop_infected': 250,
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                    fig_path = dirname + '/figs_oakland/Oakland-projections' + '.png',
                    interval=30, n_cols=1,
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['Oakland'].results['new_infections']['No changes to current lockdown restrictions']['best'][192:238])
    new_diag_LB_sep_oct = sum(scens['scenarios']['Oakland'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][192:238])
    cum_inf_LB_sep_oct = scens['scenarios']['Oakland'].results['cum_infections']['No changes to current lockdown restrictions']['best'][228]
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['Oakland'].results['new_infections']['No changes to current lockdown restrictions']['best'][239:283])
    new_diag_LB_nov_dec = sum(scens['scenarios']['Oakland'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][239:283])
    cum_inf_LB_nov_dec = scens['scenarios']['Oakland'].results['cum_infections']['No changes to current lockdown restrictions']['best'][283]
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['Oakland'].results['new_infections']['Small easing of restrictions on July 15']['best'][192:238])
    new_diag_MB_sep_oct = sum(scens['scenarios']['Oakland'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][192:238])
    cum_inf_MB_sep_oct = scens['scenarios']['Oakland'].results['cum_infections']['Small easing of restrictions on July 15']['best'][238]
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['Oakland'].results['new_infections']['Small easing of restrictions on July 15']['best'][239:283])
    ...
    workbook = xlsxwriter.Workbook('Oakland_projections.xlsx')
