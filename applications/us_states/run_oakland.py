...
if __name__ == "__main__":
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                    fig_path = dirname + '/Oakland-projections' + '.png',
                    interval = 30, n_cols = 1,
    ...
    remain = sum(scens['scenarios']['Oakland'].results['new_infections']['No changes to current lockdown restrictions']['best'][239:359])
    print('Lockdown remains in place =', remain)
    relax_2 = sum( scens['scenarios']['Oakland'].results['new_infections']['Small easing of restrictions on August 15']['best'][239:359])
    print('Small easing of restrictions on August 15  =', relax_2)
    relax_3 = sum(scens['scenarios']['Oakland'].results['new_infections']['Moderate easing of restrictions on August 15'][ 'best'][239:359])
    print('Moderate easing of restrictions on August 15 =', relax_3)
    relax_4 = sum(scens['scenarios']['Oakland'].results['new_infections']['Small easing of restrictions on July 15']['best'][239:359])
    print('Small easing of restrictions on July 15 =', relax_4)
    relax_5 = sum(scens['scenarios']['Oakland'].results['new_infections']['Moderate easing of restrictions on July 15']['best'][239:359])
    print('Moderate easing of restrictions on July 15 =', relax_5)


    remain = scens['scenarios']['Oakland'].results['cum_infections']['No changes to current lockdown restrictions']['best'][359]
    print('Lockdown remains in place =', remain)
    relax_2 = scens['scenarios']['Oakland'].results['cum_infections']['Small easing of restrictions on August 15']['best'][359]
    print('Small easing of restrictions on August 15  =', relax_2)
    relax_3 = scens['scenarios']['Oakland'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][359]
    print('Moderate easing of restrictions on August 15 =', relax_3)
    relax_4 = scens['scenarios']['Oakland'].results['cum_infections']['Small easing of restrictions on July 15']['best'][359]
    print('Small easing of restrictions on July 15  =', relax_4)
    relax_5 = scens['scenarios']['Oakland'].results['cum_infections']['Moderate easing of restrictions on July 15']['best'][359]
    print('Moderate easing of restrictions on July 15 =', relax_5)