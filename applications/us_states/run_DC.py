...
if __name__ == "__main__":
    ...
    user_pars = {'DC': {'pop_size': int(10e4),
                               'beta': 0.0805,
                               'n_days': 360,
                               'calibration_end': '2020-07-14'}}

    mid_july = 131 # make this the key date
    ...
    scen_opts = {'DC': {'Small easing of restrictions in mid-August': 
                              {'replace': (['relax2'], [['relax3']], [[mid_aug]])},
                 
                            'Moderate easing of restrictions in mid-August': 
                              {'replace': (['relax2'], [['relax4']], [[mid_aug]])},
                 
                            'Small easing of restrictions in end-July': 
                              {'replace': (['relax2'], [['relax3']], [[end_july]])},
                 
                            'Moderate easing of restrictions in end-July': 
                              {'replace': (['relax2'], [['relax4']], [[end_july]])},
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                        fig_path=dirname + '/figs/DC-projections' + '.png',
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['DC'].results['new_infections']['No changes to current lockdown restrictions']['best'][mid_sep:end_oct])    
    new_diag_LB_sep_oct = sum(scens['scenarios']['DC'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][mid_sep:end_oct])    
    cum_inf_LB_sep_oct = scens['scenarios']['DC'].results['cum_infections']['No changes to current lockdown restrictions']['best'][end_oct]    
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['DC'].results['new_infections']['No changes to current lockdown restrictions']['best'][mid_nov:end_dec])    
    new_diag_LB_nov_dec = sum(scens['scenarios']['DC'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][mid_nov:end_dec])    
    cum_inf_LB_nov_dec = scens['scenarios']['DC'].results['cum_infections']['No changes to current lockdown restrictions']['best'][end_dec]    
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['DC'].results['new_infections']['Small easing of restrictions in end-July']['best'][mid_sep:end_oct])    
    new_diag_MB_sep_oct = sum(scens['scenarios']['DC'].results['new_diagnoses']['Small easing of restrictions in end-July']['best'][mid_sep:end_oct])    
    cum_inf_MB_sep_oct = scens['scenarios']['DC'].results['cum_infections']['Small easing of restrictions in end-July']['best'][end_oct]    
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['DC'].results['new_infections']['Small easing of restrictions in end-July']['best'][mid_nov:end_dec])    
    new_diag_MB_nov_dec = sum(scens['scenarios']['DC'].results['new_diagnoses']['Small easing of restrictions in end-July']['best'][mid_nov:end_dec])    
    cum_inf_MB_nov_dec = scens['scenarios']['DC'].results['cum_infections']['Small easing of restrictions in end-July']['best'][end_dec]    
    ...
    # Upper Bound: moderate change end-August    
    new_inf_UB_sep_oct = sum(scens['scenarios']['DC'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][mid_sep:end_oct])    
    new_diag_UB_sep_oct = sum(scens['scenarios']['DC'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][mid_sep:end_oct])    
    cum_inf_UB_sep_oct = scens['scenarios']['DC'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][end_oct]    
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['DC'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][mid_nov:end_dec])    
    new_diag_UB_nov_dec = sum(scens['scenarios']['DC'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][mid_nov:end_dec])    
    cum_inf_UB_nov_dec = scens['scenarios']['DC'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][end_dec]    
    ...
    workbook = xlsxwriter.Workbook('DC_projections.xlsx')
    ...
    daily_projections = [
        ...
        ['Small easing of restrictions in end-July'] + [int(val) for val in daily_inf_small_sep],
        ['Moderate easing of restrictions in end-July'] + [int(val) for val in daily_inf_mod_sep],
        ...
        ['Small easing of restrictions in end-July'] + [int(val) for val in daily_death_small_sep],
        ['Moderate easing of restrictions in end-July'] + [int(val) for val in daily_death_mod_sep],
        ...
        ['Small easing of restrictions in end-July'] + [int(val) for val in daily_diag_small_sep],
        ['Moderate easing of restrictions in end-July'] + [int(val) for val in daily_diag_mod_sep],
