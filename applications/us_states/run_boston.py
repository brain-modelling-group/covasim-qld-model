...
if __name__ == "__main__":
    ...
    # policy_vals = {'Boston': {'lockdown1': {'beta': 0.9},
    #                            'lockdown2': {'beta': 0.6},
    ...
    scen_opts = {'Boston': {'Small easing of restrictions on August 15': {'replace': (['relax2'], [['relax3']], [[173]])},
    ...
    October1_10release = sum(scens['scenarios']['Boston'].results['new_infections']['Small easing of restrictions on August 15']['best'][251:370])
    ...
    October1_40release = sum(scens['scenarios']['Boston'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][251:370])
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                       fig_path=dirname + '/Boston-new_diag' + '.png',
