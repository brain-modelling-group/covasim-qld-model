...
if __name__ == "__main__":
    ...
    #                                                     [[140]])}}}
    scen_opts = {'New York': {'Small easing of restrictions on August 15': 
                              {'replace': (['relax2'], [['relax3']], [[178]]),
                              'policies': {'relax3': {'beta': 0.4}}},
                 
                            'Moderate easing of restrictions on August 15': 
                              {'replace': (['relax2'], [['relax4']], [[178]]),
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['New York'].results['new_infections']['No changes to current lockdown restrictions']['best'][(197 + extra_days):(243 + extra_days)])
    new_diag_LB_sep_oct = sum(scens['scenarios']['New York'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][(197 + extra_days):(243 + extra_days)])
    cum_inf_LB_sep_oct = scens['scenarios']['New York'].results['cum_infections']['No changes to current lockdown restrictions']['best'][(243 + extra_days)]
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['New York'].results['new_infections']['No changes to current lockdown restrictions']['best'][(244 + extra_days):(288 + extra_days)])
    new_diag_LB_nov_dec = sum(scens['scenarios']['New York'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][(244 + extra_days):(288 + extra_days)])
    cum_inf_LB_nov_dec = scens['scenarios']['New York'].results['cum_infections']['No changes to current lockdown restrictions']['best'][(288 + extra_days)]
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['New York'].results['new_infections']['Small easing of restrictions on July 15']['best'][(197 + extra_days):(243 + extra_days)])
    new_diag_MB_sep_oct = sum(scens['scenarios']['New York'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][(197 + extra_days):(243 + extra_days)])
    cum_inf_MB_sep_oct = scens['scenarios']['New York'].results['cum_infections']['Small easing of restrictions on July 15']['best'][(243 + extra_days)]
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['New York'].results['new_infections']['Small easing of restrictions on July 15']['best'][(244 + extra_days):(288 + extra_days)])
    new_diag_MB_nov_dec = sum(scens['scenarios']['New York'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][(244 + extra_days):(288 + extra_days)])
    cum_inf_MB_nov_dec = scens['scenarios']['New York'].results['cum_infections']['Small easing of restrictions on July 15']['best'][(288 + extra_days)]
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['New York'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][(197 + extra_days):(243 + extra_days)])
    new_diag_UB_sep_oct = sum(scens['scenarios']['New York'].results['new_diagnoses']['Moderate easing of restrictions on August 15']['best'][(197 + extra_days):(243 + extra_days)])
    cum_inf_UB_sep_oct = scens['scenarios']['New York'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][(243 + extra_days)]
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['New York'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][(244+extra_days):(288+extra_days)])
    new_diag_UB_nov_dec = sum(scens['scenarios']['New York'].results['new_diagnoses']['Moderate easing of restrictions on August 15']['best'][(244+extra_days):(288+extra_days)])
    cum_inf_UB_nov_dec = scens['scenarios']['New York'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][(288 + extra_days)]
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                        fig_path=dirname + '/figs/New-York-projections_t' + '.png',
                        interval=30, n_cols=1,
