...
if __name__ == "__main__":
    ...
    user_pars = {'Richmond': {'pop_size': int(5e4),
                        'beta': 0.0743,
                        'n_days': 309,
                        'pop_infected': 10,
    ...
    scen_opts = {'Richmond': {'Small easing of restrictions on August 15':
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=False, do_show=True,
                       fig_path=dirname + '/figs/Richmond-calibrate' + '.png',
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                       fig_path=dirname + '/figs/Richmond-projections' + '.png',
