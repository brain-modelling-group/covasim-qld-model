...
if __name__ == "__main__":
    ...
    #                                                     [[140]])}}}
    scen_opts = {'New Orleans': {'Small easing of restrictions on August 1': 
                              {'replace': (['relax2'], [['relax3']], [[159]]),
                              'policies': {'relax3': {'beta': 0.45}}},
                 
                            'Moderate easing of restrictions on August 1': 
                              {'replace': (['relax2'], [['relax4']], [[159]]),
                              'policies': {'relax4': {'beta': 0.65}}},
    ...
    no_release = sum(scens['scenarios']['New Orleans'].results['new_infections']['No changes to current lockdown restrictions']['best'][251:370])
    print('Sum of new infections: No changes to current lockdown restrictions =', no_release)
    august_smallrelease = sum(scens['scenarios']['New Orleans'].results['new_infections']['Small easing of restrictions on August 1']['best'][251:370])
    print('Sum of new infections: Small easing of restrictions on August 1 =', august_smallrelease)
    august_moderaterelease = sum(scens['scenarios']['New Orleans'].results['new_infections']['Moderate easing of restrictions on August 1']['best'][251:370])
    print('Sum of new infections: Moderate easing of restrictions on August 1 =', august_moderaterelease)
    july_smallrelease = sum(scens['scenarios']['New Orleans'].results['new_infections']['Small easing of restrictions on July 15']['best'][251:370])
    print('Sum of new infections: Small easing of restrictions on July 15 =', july_smallrelease)
    july_moderaterelease = sum(scens['scenarios']['New Orleans'].results['new_infections']['Moderate easing of restrictions on July 15']['best'][251:370])
    print('Sum of new infections: Moderate easing of restrictions on on July 15 =', july_moderaterelease)
    

    no_release = scens['scenarios']['New Orleans'].results['cum_infections']['No changes to current lockdown restrictions']['best'][370]
    print('Cumulative infections: No changes to current lockdown restrictions =', no_release)
    august_smallrelease = scens['scenarios']['New Orleans'].results['cum_infections']['Small easing of restrictions on August 1']['best'][370]
    print('Cumulative infections: Small easing of restrictions on August 1 =', august_smallrelease)
    august_moderatelrelease = scens['scenarios']['New Orleans'].results['cum_infections']['Moderate easing of restrictions on August 1']['best'][370]
    print('Cumulative infections: Moderate easing of restrictions on August 1 =', august_moderatelrelease)
    july_smallrelease = scens['scenarios']['New Orleans'].results['cum_infections']['Small easing of restrictions on July 15']['best'][370]
    print('Cumulative infections: Small easing of restrictions on July 15 =', july_smallrelease)
    july_moderatelrelease = scens['scenarios']['New Orleans'].results['cum_infections']['Moderate easing of restrictions on July 15']['best'][370]
