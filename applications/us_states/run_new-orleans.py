...
if __name__ == "__main__":
    ...
    new_no_release = sum(scens['scenarios']['New Orleans'].results['new_infections']['No changes to current lockdown restrictions']['best'][251:370])    
    new_august_smallrelease = sum(scens['scenarios']['New Orleans'].results['new_infections']['Small easing of restrictions on August 15']['best'][251:370])    
    new_august_moderaterelease = sum(scens['scenarios']['New Orleans'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][251:370])    
    new_july_smallrelease = sum(scens['scenarios']['New Orleans'].results['new_infections']['Small easing of restrictions on July 15']['best'][251:370])
    new_july_moderaterelease = sum(scens['scenarios']['New Orleans'].results['new_infections']['Moderate easing of restrictions on July 15']['best'][251:370])
    cum_no_release = scens['scenarios']['New Orleans'].results['cum_infections']['No changes to current lockdown restrictions']['best'][370]
    cum_august_smallrelease = scens['scenarios']['New Orleans'].results['cum_infections']['Small easing of restrictions on August 15']['best'][370]
    cum_august_moderatelrelease = scens['scenarios']['New Orleans'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][370]
    cum_july_smallrelease = scens['scenarios']['New Orleans'].results['cum_infections']['Small easing of restrictions on July 15']['best'][370]
    cum_july_moderatelrelease = scens['scenarios']['New Orleans'].results['cum_infections']['Moderate easing of restrictions on July 15']['best'][370]
    
    
    with open('New-Orleans_projections.txt', 'w') as f:
