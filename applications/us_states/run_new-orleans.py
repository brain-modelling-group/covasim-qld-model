...
if __name__ == "__main__":
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['New Orleans'].results['new_infections']['No changes to current lockdown restrictions']['best'][203:248])    
    new_diag_LB_sep_oct = sum(scens['scenarios']['New Orleans'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][203:248])    
    cum_inf_LB_sep_oct = scens['scenarios']['New Orleans'].results['cum_infections']['No changes to current lockdown restrictions']['best'][248]    
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['New Orleans'].results['new_infections']['No changes to current lockdown restrictions']['best'][250:293])    
    new_diag_LB_nov_dec = sum(scens['scenarios']['New Orleans'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][250:293])    
    cum_inf_LB_nov_dec = scens['scenarios']['New Orleans'].results['cum_infections']['No changes to current lockdown restrictions']['best'][293]    
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['New Orleans'].results['new_infections']['Small easing of restrictions in mid-July']['best'][203:248])    
    new_diag_MB_sep_oct = sum(scens['scenarios']['New Orleans'].results['new_diagnoses']['Small easing of restrictions in mid-July']['best'][203:248])    
    cum_inf_MB_sep_oct = scens['scenarios']['New Orleans'].results['cum_infections']['Small easing of restrictions in mid-July']['best'][248]    
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['New Orleans'].results['new_infections']['Small easing of restrictions in mid-July']['best'][250:293])    
    new_diag_MB_nov_dec = sum(scens['scenarios']['New Orleans'].results['new_diagnoses']['Small easing of restrictions in mid-July']['best'][250:293])    
    cum_inf_MB_nov_dec = scens['scenarios']['New Orleans'].results['cum_infections']['Small easing of restrictions in mid-July']['best'][293]    
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['New Orleans'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][203:248])    
    new_diag_UB_sep_oct = sum(scens['scenarios']['New Orleans'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][203:248])    
    cum_inf_UB_sep_oct = scens['scenarios']['New Orleans'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][248]    
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['New Orleans'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][250:293])    
    new_diag_UB_nov_dec = sum(scens['scenarios']['New Orleans'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][250:293])    
    cum_inf_UB_nov_dec = scens['scenarios']['New Orleans'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][293]    
