...
if __name__ == "__main__":
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_infections']['No changes to current lockdown restrictions']['best'][mid_sep:end_oct])
    new_diag_LB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][mid_sep:end_oct])
    cum_inf_LB_sep_oct = scens['scenarios']['Detroit'].results['cum_infections']['No changes to current lockdown restrictions']['best'][end_oct]
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_infections']['No changes to current lockdown restrictions']['best'][mid_nov:end_dec])
    new_diag_LB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][mid_nov:end_dec])
    cum_inf_LB_nov_dec = scens['scenarios']['Detroit'].results['cum_infections']['No changes to current lockdown restrictions']['best'][end_dec]
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_infections']['Small easing of restrictions in mid-July']['best'][mid_sep:end_oct])
    new_diag_MB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['Small easing of restrictions in mid-July']['best'][mid_sep:end_oct])
    cum_inf_MB_sep_oct = scens['scenarios']['Detroit'].results['cum_infections']['Small easing of restrictions in mid-July']['best'][end_oct]
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_infections']['Small easing of restrictions in mid-July']['best'][mid_nov:end_dec])
    new_diag_MB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['Small easing of restrictions in mid-July']['best'][mid_nov:end_dec])
    cum_inf_MB_nov_dec = scens['scenarios']['Detroit'].results['cum_infections']['Small easing of restrictions in mid-July']['best'][end_dec]
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][mid_sep:end_oct])
    new_diag_UB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][mid_sep:end_oct])
    cum_inf_UB_sep_oct = scens['scenarios']['Detroit'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][end_oct]
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][mid_nov:end_dec])
    new_diag_UB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][mid_nov:end_dec])
    cum_inf_UB_nov_dec = scens['scenarios']['Detroit'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][end_dec]
