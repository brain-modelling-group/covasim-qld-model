...
if __name__ == "__main__":
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_infections']['No changes to current lockdown restrictions']['best'][(197 + extra_days):(243 + extra_days)])
    new_diag_LB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][(197 + extra_days):(243 + extra_days)])
    cum_inf_LB_sep_oct = scens['scenarios']['Detroit'].results['cum_infections']['No changes to current lockdown restrictions']['best'][(243 + extra_days)]
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_infections']['No changes to current lockdown restrictions']['best'][(244 + extra_days):(288 + extra_days)])
    new_diag_LB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][(244 + extra_days):(288 + extra_days)])
    cum_inf_LB_nov_dec = scens['scenarios']['Detroit'].results['cum_infections']['No changes to current lockdown restrictions']['best'][(288 + extra_days)]
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_infections']['Small easing of restrictions on July 15']['best'][(197 + extra_days):(243 + extra_days)])
    new_diag_MB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][(197 + extra_days):(243 + extra_days)])
    cum_inf_MB_sep_oct = scens['scenarios']['Detroit'].results['cum_infections']['Small easing of restrictions on July 15']['best'][(243 + extra_days)]
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_infections']['Small easing of restrictions on July 15']['best'][(244 + extra_days):(288 + extra_days)])
    new_diag_MB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][(244 + extra_days):(288 + extra_days)])
    cum_inf_MB_nov_dec = scens['scenarios']['Detroit'].results['cum_infections']['Small easing of restrictions on July 15']['best'][(288 + extra_days)]
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][(197 + extra_days):(243 + extra_days)])
    new_diag_UB_sep_oct = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['Moderate easing of restrictions on August 15']['best'][(197 + extra_days):(243 + extra_days)])
    cum_inf_UB_sep_oct = scens['scenarios']['Detroit'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][(243 + extra_days)]
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][(244+extra_days):(288+extra_days)])
    new_diag_UB_nov_dec = sum(scens['scenarios']['Detroit'].results['new_diagnoses']['Moderate easing of restrictions on August 15']['best'][(244+extra_days):(288+extra_days)])
    cum_inf_UB_nov_dec = scens['scenarios']['Detroit'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][(288 + extra_days)]
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                        fig_path=dirname + '/figs/Detroit-projections_t' + '.png',
                        interval=30, n_cols=1,
