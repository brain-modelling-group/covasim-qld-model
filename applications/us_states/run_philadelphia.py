...
if __name__ == "__main__":
    ...
    user_pars = {'Philadelphia': {'pop_size': int(10e4),
                        'beta': 0.128,
                        'n_days': 150,
                        'pop_infected': 900,
    ...
    scen_opts = {'Philadelphia': {#'Small easing of restrictions on August 15':
                                ...
                                # {'replace': (['policy_1'], [['policy_2']], [[177]])},
                                #
                                # 'Moderate easing of restrictions on August 30':
                                # {'replace': (['policy_1'], [['policy_3']], [[177]])},
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                       fig_path=dirname + '/figs/Philadelphia-calibrate' + '.png',
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=False, do_show=True,
                       fig_path=dirname + '/figs/Philadelphia-projections' + '.png',
