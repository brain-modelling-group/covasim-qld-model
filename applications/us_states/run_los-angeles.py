...
if __name__ == "__main__":
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['Los Angeles'].results['new_infections']['No changes to current lockdown restrictions']['best'][192:238])
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['Los Angeles'].results['new_infections']['Small easing of restrictions on July 15']['best'][192:238])
