...
if __name__ == "__main__":
    ...
    mid_july = 122  # make this the key date
    mid_aug = mid_july + 31
    mid_sep = mid_aug + 31
    end_oct = mid_sep + 46
    mid_nov = end_oct + 15
    ...
    # scen_opts = {'New Haven': {'No changes to current lockdown restrictions': {'replace': (['relax2'], ['relax2'], 
    #                                                     [[140]])}}}
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['New Haven'].results['new_infections']['No changes to current lockdown restrictions']['best'][mid_sep:end_oct])
    new_diag_LB_sep_oct = sum(scens['scenarios']['New Haven'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][mid_sep:end_oct])
    cum_inf_LB_sep_oct = scens['scenarios']['New Haven'].results['cum_infections']['No changes to current lockdown restrictions']['best'][end_oct]
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['New Haven'].results['new_infections']['No changes to current lockdown restrictions']['best'][mid_nov:end_dec])
    new_diag_LB_nov_dec = sum(scens['scenarios']['New Haven'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][mid_nov:end_dec])
    cum_inf_LB_nov_dec = scens['scenarios']['New Haven'].results['cum_infections']['No changes to current lockdown restrictions']['best'][end_dec]
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['New Haven'].results['new_infections']['Small easing of restrictions in mid-July']['best'][mid_sep:end_oct])
    new_diag_MB_sep_oct = sum(scens['scenarios']['New Haven'].results['new_diagnoses']['Small easing of restrictions in mid-July']['best'][mid_sep:end_oct])
    cum_inf_MB_sep_oct = scens['scenarios']['New Haven'].results['cum_infections']['Small easing of restrictions in mid-July']['best'][end_oct]
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['New Haven'].results['new_infections']['Small easing of restrictions in mid-July']['best'][mid_nov:end_dec])
    new_diag_MB_nov_dec = sum(scens['scenarios']['New Haven'].results['new_diagnoses']['Small easing of restrictions in mid-July']['best'][mid_nov:end_dec])
    cum_inf_MB_nov_dec = scens['scenarios']['New Haven'].results['cum_infections']['Small easing of restrictions in mid-July']['best'][end_dec]
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['New Haven'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][mid_sep:end_oct])
    new_diag_UB_sep_oct = sum(scens['scenarios']['New Haven'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][mid_sep:end_oct])
    cum_inf_UB_sep_oct = scens['scenarios']['New Haven'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][end_oct]
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['New Haven'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][mid_nov:end_dec])
    new_diag_UB_nov_dec = sum(scens['scenarios']['New Haven'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][mid_nov:end_dec])
    cum_inf_UB_nov_dec = scens['scenarios']['New Haven'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][end_dec]
    ...
    #                 fig_path=dirname + '/figs/New-Haven-calibrate' + '.png',
