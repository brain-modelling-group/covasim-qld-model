...
if __name__ == "__main__":
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=False, do_show=True,
                       fig_path=dirname + '/figs/cincinnati-calibrate' + '.png',
    ...
    new_inf_LB_sep_oct = sum(scens['scenarios']['Cincinnati'].results['new_infections']['No changes to current lockdown restrictions']['best'][192:238])
    new_diag_LB_sep_oct = sum(scens['scenarios']['Cincinnati'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][192:238])
    cum_inf_LB_sep_oct = scens['scenarios']['Cincinnati'].results['cum_infections']['No changes to current lockdown restrictions']['best'][228]
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['Cincinnati'].results['new_infections']['No changes to current lockdown restrictions']['best'][239:283])
    new_diag_LB_nov_dec = sum(scens['scenarios']['Cincinnati'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][239:283])
    cum_inf_LB_nov_dec = scens['scenarios']['Cincinnati'].results['cum_infections']['No changes to current lockdown restrictions']['best'][283]
    ...
    new_inf_MB_sep_oct = sum(scens['scenarios']['Cincinnati'].results['new_infections']['Small easing of restrictions on July 15']['best'][192:238])
    new_diag_MB_sep_oct = sum(scens['scenarios']['Cincinnati'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][192:238])
    cum_inf_MB_sep_oct = scens['scenarios']['Cincinnati'].results['cum_infections']['Small easing of restrictions on July 15']['best'][238]
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['Cincinnati'].results['new_infections']['Small easing of restrictions on July 15']['best'][239:283])
    new_diag_MB_nov_dec = sum(scens['scenarios']['Cincinnati'].results['new_diagnoses']['Small easing of restrictions on July 15']['best'][239:283])
    cum_inf_MB_nov_dec = scens['scenarios']['Cincinnati'].results['cum_infections']['Small easing of restrictions on July 15']['best'][283]
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['Cincinnati'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][192:238])
    new_diag_UB_sep_oct = sum(scens['scenarios']['Cincinnati'].results['new_diagnoses']['Moderate easing of restrictions on August 15']['best'][192:238])
    cum_inf_UB_sep_oct = scens['scenarios']['Cincinnati'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][238]
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['Cincinnati'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][239:283])
    new_diag_UB_nov_dec = sum(scens['scenarios']['Cincinnati'].results['new_diagnoses']['Moderate easing of restrictions on August 15']['best'][239:283])
    cum_inf_UB_nov_dec = scens['scenarios']['Cincinnati'].results['cum_infections']['Moderate easing of restrictions on August 15']['best'][283]
    ...
    workbook = xlsxwriter.Workbook('Cincinnati_projections.xlsx')
