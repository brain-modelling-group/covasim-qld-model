...
if __name__ == "__main__":
    ...
    scen_opts = {'Nashville': {'Moderate easing of current restrictions on August 15':
                               ...
                               'Implement and maintain strict lockdown':
                                   {'replace': (['lockdown4'], [['lockdown5']], [[132]]),
                                    'policies': {'lockdown5': {'beta': 0.2}}},

                               'Implement weaker lockdown':
                                   {'replace': (['lockdown4'], [['lockdown5']], [[132]]),
                                    'policies': {'lockdown5': {'beta': 0.4}}},
    ...
    new_lockdownrelease_SO = sum(
        scens['scenarios']['Nashville'].results['new_infections']['Implement weaker lockdown']['best'][203:246]) * 100 * 30 / 42 / pop
    ...
    diag_lockdownrelease_SO = sum(
        scens['scenarios']['Nashville'].results['new_diagnoses']['Implement weaker lockdown']['best'][203:246]) * 100 * 30 / 42 / pop
    ...
    scens['scenarios']['Nashville'].results['cum_infections']['Implement weaker lockdown']['best'][246] / pop
    ...
    new_lockdownrelease_ND = sum(
        scens['scenarios']['Nashville'].results['new_infections']['Implement weaker lockdown']['best'][264:307]) * 100 * 30 / 42 / pop
    ...
    diag_lockdownrelease_ND = sum(
        scens['scenarios']['Nashville'].results['new_diagnoses']['Implement weaker lockdown']['best'][264:307]) * 100 * 30 / 42 / pop
    ...
    scens['scenarios']['Nashville'].results['cum_infections']['Implement weaker lockdown']['best'][307] / pop
    ...
    with open('Nashville_projections.txt', 'w') as f:
        ...
        print('30 day incidence for Sept-Oct: Implement weaker lockdown =', new_lockdownrelease_SO, file=f)
        ...
        print('30 day detected cases for Sept-Oct: Implement weaker lockdown =', diag_lockdownrelease_SO, file=f)
        ...
        print('Cumulative infections for Sept-Oct: Implement weaker lockdown =', cum_lockdownrelease_SO, file=f)
        ...
        print('30 day incidence for Nov-Dec: Implement weaker lockdown =', new_lockdownrelease_ND, file=f)
        ...
        print('30 day detected cases for Nov-Dec: Implement weaker lockdown =', diag_lockdownrelease_ND, file=f)
        ...
        print('Cumulative infections for Nov-Dec: Implement weaker lockdown =', cum_lockdownrelease_ND, file=f)
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                       ...
                       font_size=11,
                       # y_lim={'new_infections': 500},
                       #legend_args={'loc': 'lower right', 'bbox_to_anchor': (1.0, -1.6)},
