...
if __name__ == "__main__":
    ...
    policy_vals = {'Brevard': {'lockdown': {'beta': .8},
                            'relax_1': {'beta': .14},
                            'relax_2': {'beta': .3},
                            'relax_3': {'beta': .4},
                            'relax_4': {'beta': .3},
    ...
    policy_change = {'Brevard': {#'Small easing of restrictions on July 15': {'replace': (['relax_1'], [['relax_2']], [[132]])},
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                       fig_path=dirname + '/Brevard_in_prog_infections_year_long' + '.png',
                       interval=30,
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=False, do_show=True,
                       fig_path=dirname + '/Brevard_in_prog_deaths_calibrate_year_long' + '.png',
                       interval=30,
                       fig_args=dict(figsize=(10, 5), dpi=100),
                       font_size=11,
                       # y_lim={'new_infections': 500},
    ...
    remain = sum(scens['Brevard'].results['new_infections']['No changes to current lockdown restrictions']['best'][241:361])
    print('Lockdown remains in place =', remain)
    #relax_2 = sum(scens['Brevard'].results['new_infections']['Small easing of restrictions on July 15']['best'][241:361])
    #print('Lockdown relax July small  =', relax_2)
    #relax_3 = sum(scens['Brevard'].results['new_infections']['Moderate easing of restrictions on July 15']['best'][241:361])
    #print('Lockdown relax July moderate =', relax_3)
    #relax_4 = sum(scens['Brevard'].results['new_infections']['Small easing of restrictions on August 15']['best'][241:361])
    #print('Lockdown relax August small  =', relax_4)
    #relax_5 = sum(scens['Brevard'].results['new_infections']['Moderate easing of restrictions on August 15']['best'][241:361])
