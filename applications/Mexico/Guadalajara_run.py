...
if __name__ == "__main__":
    ...
    new_inf_UB_sep_oct = sum(scens['scenarios']['Guadalajara'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][mid_sep:end_oct])    
    new_diag_UB_sep_oct = sum(scens['scenarios']['Guadalajara'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][mid_sep:end_oct])    
    cum_inf_UB_sep_oct = scens['scenarios']['Guadalajara'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][end_oct]    
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['Guadalajara'].results['new_infections']['Moderate easing of restrictions in mid-August']['best'][start_nov:end_dec])    
    new_diag_UB_nov_dec = sum(scens['scenarios']['Guadalajara'].results['new_diagnoses']['Moderate easing of restrictions in mid-August']['best'][start_nov:end_dec])    
    cum_inf_UB_nov_dec = scens['scenarios']['Guadalajara'].results['cum_infections']['Moderate easing of restrictions in mid-August']['best'][end_dec]    
