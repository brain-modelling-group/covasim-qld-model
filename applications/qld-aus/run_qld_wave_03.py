...
def make_sim(case_to_run, load_pop=True, popfile='qldppl.pop', datafile=None, agedatafile=None, input_args=None):
    ...
    pars = {'pop_size': 200e3,    # Population size
            ...
            'iso_factor':  pd.Series([0.45,    0.25,   0.25,   0.25,   0.25,   0.25,    0.25,    0.25,   0.25,   0.25,    0.25,    0.25,      0.25,   0.25], index=layers).to_dict(),
...
if __name__ == '__main__':
    ...
    # Filepaths
    inputsfolder = 'inputs'
    resultsfolder = 'results_iso-0-25_gt_0-025_eos_2021-01-31'
