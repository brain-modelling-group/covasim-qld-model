...
def make_sim(case_to_run, load_pop=True, popfile='qldppl.pop', datafile=None, agedatafile=None, input_args=None):
    ...
    pars = {'pop_size': 200e3,    # Population size
            ...
            'iso_factor':  pd.Series([0.95,    0.75,   0.75,   0.75,   0.75,   0.75,    0.75,    0.75,   0.75,   0.75,    0.75,    0.75,      0.75,   0.75], index=layers).to_dict(),
    ...
    sim.pars['interventions'].append(cv.dynamic_pars({'beta': {'days': [sim.day('2020-03-30'), # lockdown
                                                                        ...
                                                                        sim.day('2020-11-01'), # 
                                                                        sim.day('2020-12-01')], 
                                                               'vals': [0.01, 0.01, 0.010, 0.010]}}, do_plot=False))
...
if __name__ == '__main__':
    ...
    # Filepaths
    inputsfolder = 'inputs'
    resultsfolder = 'results_iso-0-50_gt_0-010_eos_2021-01-31'
