...
if __name__ == "__main__":
    ...
    policy_change = {'Mexico city': {'lockdown restrictions relaxed by 5% on September 1': {'replace': (['phase2'], [['phase3']],
                                                        [[188]])},
                                     'lockdown restrictions relaxed by 5% on September 30': {'replace': (['phase2'], [['phase3']],
                                                        [[216]])}}}
    ...
    August_release = sum(scens['Mexico city'].results['new_infections']['lockdown restrictions relaxed by 5% on September 1']['best'][249:368])
    print('Restrictions relaxed in August =', August_release)
    September_release = sum(scens['Mexico city'].results['new_infections']['lockdown restrictions relaxed by 5% on September 30']['best'][249:368])
