...
if __name__ == "__main__":
    ...
    scen_opts = {'NSW': {'Small easing of restrictions in end-September': 
                              {'replace': (['bars'], [['relax4']], [[end_sep]])},

                            'Moderate easing of restrictions in end-September': 
                              {'replace': (['bars'], [['relax5']], [[end_sep]])},

                            'Small easing of restrictions in end-August': 
                              {'replace': (['bars'], [['relax4']], [[end_aug]])},

                            'Moderate easing of restrictions in end-August': 
                              {'replace': (['bars'], [['relax5']], [[end_aug]])},
    ...
    utils.policy_plot2(scens, plot_ints=False, do_save=True, do_show=True,
                        fig_path=dirname + '/figs/NSW-projection' + '.png',
                  interval=30, n_cols=1,
                  fig_args=dict(figsize=(10, 8), dpi=100),
                  font_size=11,
                  # y_lim={'new_infections': 100},
    ...
    # Lower Bound
    new_inf_LB_sep_oct = sum(scens['scenarios']['NSW'].results['new_infections']['No changes to current lockdown restrictions']['best'][mid_sep:end_oct])    
    new_diag_LB_sep_oct = sum(scens['scenarios']['NSW'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][mid_sep:end_oct])    
    cum_inf_LB_sep_oct = scens['scenarios']['NSW'].results['cum_infections']['No changes to current lockdown restrictions']['best'][end_oct]    
    ...
    new_inf_LB_nov_dec = sum(scens['scenarios']['NSW'].results['new_infections']['No changes to current lockdown restrictions']['best'][start_nov:end_dec])    
    new_diag_LB_nov_dec = sum(scens['scenarios']['NSW'].results['new_diagnoses']['No changes to current lockdown restrictions']['best'][start_nov:end_dec])    
    cum_inf_LB_nov_dec = scens['scenarios']['NSW'].results['cum_infections']['No changes to current lockdown restrictions']['best'][end_dec]    
    ...
    # Mid Bound   
    new_inf_MB_sep_oct = sum(scens['scenarios']['NSW'].results['new_infections']['Small easing of restrictions in end-September']['best'][mid_sep:end_oct])    
    new_diag_MB_sep_oct = sum(scens['scenarios']['NSW'].results['new_diagnoses']['Small easing of restrictions in end-September']['best'][mid_sep:end_oct])    
    cum_inf_MB_sep_oct = scens['scenarios']['NSW'].results['cum_infections']['Small easing of restrictions in end-September']['best'][end_oct]    
    ...
    new_inf_MB_nov_dec = sum(scens['scenarios']['NSW'].results['new_infections']['Small easing of restrictions in end-September']['best'][start_nov:end_dec])    
    new_diag_MB_nov_dec = sum(scens['scenarios']['NSW'].results['new_diagnoses']['Small easing of restrictions in end-September']['best'][start_nov:end_dec])    
    cum_inf_MB_nov_dec = scens['scenarios']['NSW'].results['cum_infections']['Small easing of restrictions in end-September']['best'][end_dec]    
    ...
    # Upper Bound    
    new_inf_UB_sep_oct = sum(scens['scenarios']['NSW'].results['new_infections']['Moderate easing of restrictions in end-August']['best'][mid_sep:end_oct])    
    new_diag_UB_sep_oct = sum(scens['scenarios']['NSW'].results['new_diagnoses']['Moderate easing of restrictions in end-August']['best'][mid_sep:end_oct])    
    cum_inf_UB_sep_oct = scens['scenarios']['NSW'].results['cum_infections']['Moderate easing of restrictions in end-August']['best'][end_oct]    
    ...
    new_inf_UB_nov_dec = sum(scens['scenarios']['NSW'].results['new_infections']['Moderate easing of restrictions in end-August']['best'][start_nov:end_dec])    
    new_diag_UB_nov_dec = sum(scens['scenarios']['NSW'].results['new_diagnoses']['Moderate easing of restrictions in end-August']['best'][start_nov:end_dec])    
    cum_inf_UB_nov_dec = scens['scenarios']['NSW'].results['cum_infections']['Moderate easing of restrictions in end-August']['best'][end_dec]    
    ...
    workbook = xlsxwriter.Workbook('NSW_projections.xlsx')     
    ...
    daily_projections = [
        ...
        ['New infections'],
        ['Small easing of restrictions in end-August'] + [int(val) for val in daily_inf_small_aug],
        ['Moderate easing of restrictions in end-August'] + [int(val) for val in daily_inf_mod_aug],
        ['Small easing of restrictions in end-September'] + [int(val) for val in daily_inf_small_sep],
        ['Moderate easing of restrictions in end-September'] + [int(val) for val in daily_inf_mod_sep],
        ['No changes to current lockdown restrictions'] + [int(val) for val in daily_inf_no_release],
        ['New deaths'],
        ['Small easing of restrictions in end-August'] + [int(val) for val in daily_death_small_aug],
        ['Moderate easing of restrictions in end-August'] + [int(val) for val in daily_death_mod_aug],
        ['Small easing of restrictions in end-September'] + [int(val) for val in daily_death_small_sep],
        ['Moderate easing of restrictions in end-September'] + [int(val) for val in daily_death_mod_sep],
        ['No changes to current lockdown restrictions'] + [int(val) for val in daily_death_no_release],
        ['New diagnoses'],
        ['Small easing of restrictions in end-August'] + [int(val) for val in daily_diag_small_aug],
        ['Moderate easing of restrictions in end-August'] + [int(val) for val in daily_diag_mod_aug],
        ['Small easing of restrictions in end-September'] + [int(val) for val in daily_diag_small_sep],
        ['Moderate easing of restrictions in end-September'] + [int(val) for val in daily_diag_mod_sep],
