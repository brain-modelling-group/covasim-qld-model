...
outbreak_cases = ['outbreak', 'under control', 'contained']
column_names = ["outbreak_inf_prob", "control_inf_prob", "contained_inf_prob"]
...
barplot_cl(dfcloz_sub, outbreak_cases, column_names, "cluster_size", 'cluster size', "fig_prob_inf_barh_cluster_oz.png")
barplot_cl(dfcluk_sub, outbreak_cases, column_names, "cluster_size", 'cluster size', "fig_prob_inf_barh_cluster_uk.png")
...
barplot_pl(dfploz_sub, outbreak_cases, column_names, "poisson_lambda", 'daily arrivals', "fig_prob_inf_barh_poisson_oz.png")
barplot_pl(dfpluk_sub, outbreak_cases, column_names, "poisson_lambda", 'daily arrivals', "fig_prob_inf_barh_poisson_uk.png")
