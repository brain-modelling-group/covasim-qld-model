...
def get_subframe(df, num_tests, column_name, col_th):
    ...
    df_sub = df_sub[["iq_compliance", which_outbreak_prob, column_name]]
    df_map = df_sub.pivot("iq_compliance", column_name, which_outbreak_prob)
    return df_map
...
plot_heatmaps([dfcloz_map, dfcluk_map], ["fig_prob_outbreak_oc_map_cluster_oz.png", "fig_prob_outbreak_oc_map_cluster_uk.png"])
...
plot_heatmaps([dfploz_map, dfpluk_map], ["fig_prob_outbreak_oc_map_poisson_oz.png", "fig_prob_outbreak_oc_map_poisson_uk.png"])
