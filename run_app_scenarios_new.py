...
#            'n_days': 200}
    ...
    policy_change = {}
    cov_values = [0., 0.3, 0.4]

    for i, cov in enumerate(cov_values):
        policy_change['Pubs/bars open with app (' + str(round(100*cov)) + '%)'] = {'replace': (['communication', 'outdoor2'], [['comm_relax'],['outdoor10']], [[60],[60]]),
                                                                                   'turn_off': (['pub_bar0', 'social','large_events','cSports','entertainment'],[60, 60,60,60,60]),
                                                                                   'app_cov': cov}
    ...
    this_fig_path = root + '/figures/pub_bar_app' + '.png'
