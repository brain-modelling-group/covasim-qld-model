...
def create_scen(scenarios,
    ...
    interventions = [beta_policies,
                     ...
                     utils.limited_contact_tracing(trace_probs={'H':1},
                                                   trace_time={'H':0},
                                                   start_day=0,
                                                   capacity=np.inf,
                                                   ),
                     utils.limited_contact_tracing(trace_probs={'S': 0.7},
                                                   trace_time={'S': 1},
                                                   start_day=0,
                                                   capacity=800,
                                                   ),
                     utils.limited_contact_tracing(trace_probs={'pub_bar':0.4,'cafe':0.4},
